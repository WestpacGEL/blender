/**
 * All functions to re-indent html
 *
...
/**
 * Indent html especially very small HTML bits
 *
 * @author Nochum Sossonko, (nsossonko@hotmail.com)
 * Based on code initially developed by: Einar Lielmanis, <elfz@laacz.lv> http://jsbeautifier.org/
 *
 * @param  {string} html_source - HTML string to be re-indented
 * @param  {object} options     - The settings object
 *
 * @return {string}             - The re-indented html
 */
function indentHtml(html_source, options) {
	D.header('indentHtml', { html_source, options });
