var OVERRIDES = function OVERRIDES(TOKENS) {
  return {};
};
  ...
  files: {
    "": [{
      "@font-face": {
        ...
        "src": "url(\"_PATH_7FF5B4E46E46717F5.woff2\") format(\"woff2\"), url(\"_PATH_7FF5B4E46E46717F5.woff\") format(\"woff\")",
        "fontWeight": "400",
        "fontStyle": "normal"
      }
    }]
...
var PACKS = {
  ...
  "focus": {
    "outline": "solid #9F4585",
    "outlineWidth": "2px",
    "outlineOffset": "3px"
  }
};
var BRAND = "WBC";
var OVERRIDES$1 = OVERRIDES();
var index = {
  SPACING: SPACING,
  COLORS: COLORS,
  LAYOUT: LAYOUT,
...
export { BRAND, COLORS, LAYOUT, OVERRIDES$1 as OVERRIDES, PACKS, SPACING, TYPE };
